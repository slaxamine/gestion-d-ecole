$.ajaxSetup({
  ...
  table = $('#classe_table').DataTable({ 
    ...
    function add() {
        $('#ajoutClasse').modal('toggle');   
      }
    $("#add_classe").submit(function(event){
    ...
    function supp(id){
      ...
      function editform(id) {
        ...
        .done(function(response){
          ...
          $('#classemodif').val(response[0].classe);
          $('#idfilmodif').val(response[0].id_filliere);
          $('#idprofmodif').val(response[0].id_prof);
          $('#idmodmodif').val(response[0].id_module);
          $('#nbetumodif').val(response[0].nbetudiant);
      ...
      $("#edit_classe").submit(function(event){
        event.preventDefault();
        var post_url = $(this).attr("action");
        var request_method = $(this).attr("method");
        var form_data = $(this).serialize();
